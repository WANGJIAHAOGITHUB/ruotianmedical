...
/**
 * <b>若天医疗门诊处方信息 - 门诊西医处方信息表实体信息</b>
 * @author WangJiahao
 * @version 1.0.0
 */
@ApiModel("若天医疗门诊处方模块 - 门诊西医处方信息表实体信息")
public class ClinicRxVO extends BaseVO {
	private static final long serialVersionUID = -5483957982058071510L;
	@ApiModelProperty("主键")
	...
	@ApiModelProperty("观察-类别")
	private String eventObsCat;                      // 观察-类别
	@ApiModelProperty("观察-类别代码")
	private String eventObsCatCode;                      // 观察-类别代码
	@ApiModelProperty("观察项目名称")
	private String eventObsItemName;                      // 观察项目名称
	@ApiModelProperty("观察-项目代码")
	private String eventObsItemCode;                      // 观察-项目代码
	@ApiModelProperty("观察-结果描述")
	private String eventObsResult;                      // 观察-结果描述
	...
	public String getEventObsCat() {
		return eventObsCat;
	}

	public void setEventObsCat(String eventObsCat) {
		this.eventObsCat = eventObsCat;
	}

	public String getEventObsCatCode() {
		return eventObsCatCode;
	}

	public void setEventObsCatCode(String eventObsCatCode) {
		this.eventObsCatCode = eventObsCatCode;
	}

	public String getEventObsItemName() {
		return eventObsItemName;
	}

	public void setEventObsItemName(String eventObsItemName) {
		this.eventObsItemName = eventObsItemName;
	}

	public String getEventObsItemCode() {
		return eventObsItemCode;
	}

	public void setEventObsItemCode(String eventObsItemCode) {
		this.eventObsItemCode = eventObsItemCode;
	}

	public String getEventObsResult() {
		return eventObsResult;
	}

	public void setEventObsResult(String eventObsResult) {
		this.eventObsResult = eventObsResult;
	}
	 ...
	 * @return
	 */
	public static ClinicRxVO getVOFromEntity(ClinicRx entity) {
		ClinicRxVO vo = new ClinicRxVO();
